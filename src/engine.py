...
# Importing datasets
train, val = dataset.read_data()  # Read data from the dataset
...
# Transform data and handle class imbalance
...
path = '../output'
val_x_scaled.to_csv(path+'/'+'test.csv', index=False)  # Save the results to a CSV file